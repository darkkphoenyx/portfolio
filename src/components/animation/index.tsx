...
//         height: "0vh",
//         ease: "Power3.easeOut",
//         onComplete: mobileLanding, // Pass the function reference
//       },
//       "-=2"
//     )
...
//       },
//       ease: "expo.easeOut",
//       onComplete: animateMainShape, // Pass the function reference
//     })
//     .from(".main-circle", {
//       duration: 1,
//       opacity: 0,
//       ease: "power3.easeInOut",
//       onComplete: animateShapes, // Pass the function reference
//     })
//     .from(".shapes .shape", {
//       duration: 1,
//       opacity: 0,
...
// export const boxHover = (e: React.MouseEvent<HTMLElement>): void => {
//   const tl = gsap.timeline();
...
// export const boxExit = (e: React.MouseEvent<HTMLElement>): void => {
//   if (window.innerWidth >= 986) {
...
// export const fadeIn = (el: gsap.TweenTarget): void => {
//   gsap.to(el, {
//     duration: 2,
//     opacity: 1,
//     y: -60,
...
// export const fadeOut = (el: gsap.TweenTarget): void => {
//   gsap.to(el, {
//     duration: 1,
//     opacity: 0,
//     y: -20,
